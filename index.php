<?php
    ...
    if (isloggedin()){
		...
		$res = elgg_get_entities(array('type' => 'object', 'subtype' => 'about', 'limit' => 1));
		if(is_array($res)){
			$area2 = elgg_view('custom_index_inria/index_public', array('title' => elgg_echo('custom_index_inria:title'),
																		'body'  => $res[0]));
		}else{
			$area2 = elgg_echo("expages:notset");	
		}
